<?php
    ...
    */
    ...
    function redirectAndExit($script){
        //Get the domain-relative URL(ex// /blog/whatever.php or /whatever.php and work
        //out the folder(ex// /blog or /).
     ...
     * has prepared for him/her (ex// on a public computer) the cracker's copy of the cookie ID will be
     * useless
     *
